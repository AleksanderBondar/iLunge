...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Root
        ref={ref}
        className={cx('bg-background flex h-10 items-center space-x-1 rounded-md border p-1', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Separator ref={ref} className={cx('bg-muted -mx-1 my-1 h-px', className)} {...props} />
));
MenubarSeparator.displayName = MenubarPrimitive.Separator.displayName;

const MenubarShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
    return <span className={cx('text-muted-foreground ml-auto text-xs tracking-widest', className)} {...props} />;
};
